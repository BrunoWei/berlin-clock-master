...
public class TimeConverterImplTest {
	...
	// The second hour row should light a red lamp for every hour left from the first hour row.
	@Test
	...
	// The first minute row should light a yellow lamp for every 5 minutes unless it's first quarter, half or last quarter
	@Test
	...
	// The second minute row should light a yellow lamp for every minute left from the first minute row.
	@Test
